...
const ProcurementParticipantModel = (props) => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ppp_name_or:
        (procurementParticipant && procurementParticipant.ppp_name_or) || "",
      ppp_name_en:
        (procurementParticipant && procurementParticipant.ppp_name_en) || "",
      ppp_name_am:
        (procurementParticipant && procurementParticipant.ppp_name_am) || "",
      ppp_tin_number:
        (procurementParticipant && procurementParticipant.ppp_tin_number) || "",
      ppp_participant_phone_number:
        (procurementParticipant &&
          procurementParticipant.ppp_participant_phone_number) ||
        "",
      ppp_participant_email:
        (procurementParticipant &&
          procurementParticipant.ppp_participant_email) ||
        "",
      ppp_participant_address:
        (procurementParticipant &&
          procurementParticipant.ppp_participant_address) ||
        "",
      ppp_description:
        (procurementParticipant && procurementParticipant.ppp_description) ||
        "",
      ppp_status:
        (procurementParticipant && procurementParticipant.ppp_status) || "",
      ppp_procurement_id:
        (procurementParticipant && procurementParticipant.ppp_procurement_id) ||
        "",

      is_deletable:
        (procurementParticipant && procurementParticipant.is_deletable) || 1,
      is_editable:
        (procurementParticipant && procurementParticipant.is_editable) || 1,
    },
  ...
  const columns = useMemo(() => {
			...
			},
			{
				...
				cell: (cellProps) => {
					return (
						<span>
							{truncateText(
								cellProps.row.original.ppp_participant_phone_number,
								30
							) || "-"}
						</span>
					);
		...
		handleProcurementParticipantClick,
		toggleViewModal,
		onClickDelete,
		data,
		t,
