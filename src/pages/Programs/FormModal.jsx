      ...
      <Modal centered size="lg" isOpen={show} toggle={toggle}>
        <div className="">
          <ModalHeader toggle={toggle}>
            {action === "add"
              ? `${t("add")} ${selectedRow?.sci_name_or ? ` ${nextLevel} under ${selectedRow.sci_name_or}` : ""}`
          ...
          <ModalBody className="">
            <Form onSubmit={validation.handleSubmit}>
              ...
              <Button
                ...
                style={{ width: "120px" }}
                disabled={addProgramInfo.isPending || updateProgramInfo.isPending}
              >
                <div className="d-flex gap-2 align-items-center justify-content-center">
                  {addProgramInfo.isPending || updateProgramInfo.isPending ? <Spinner size={"sm"} /> : ""}
