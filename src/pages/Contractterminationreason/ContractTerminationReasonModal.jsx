    ...
    >
      ...
      <ModalBody>
        <Table bordered size="sm" responsive className="table-details">
          <tbody>
            <tr>
              <th width="30%">{t("ctr_reason_name_or")}</th>
              <td>{transaction.ctr_reason_name_or || "-"}</td>
            </tr>
            <tr>
              <th>{t("ctr_reason_name_am")}</th>
              <td>{transaction.ctr_reason_name_am || "-"}</td>
            </tr>
            <tr>
              <th>{t("ctr_reason_name_en")}</th>
              <td>{transaction.ctr_reason_name_en || "-"}</td>
            </tr>
            <tr>
              <th>{t("ctr_description")}</th>
              <td>{transaction.ctr_description || "-"}</td>
            </tr>
            <tr>
              <th>{t("is_inactive")}</th>
              <td>{renderBooleanBadge(transaction.ctr_status)}</td>
            </tr>
          </tbody>
        </Table>
      </ModalBody>
