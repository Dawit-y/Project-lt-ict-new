...
const BudgetRequestTaskModel = ({requestData}) => {
  //meta title
  document.title = " BudgetRequestTask";
  ...
  const { data, isLoading, error, isError, refetch } = useFetchBudgetRequestTasks(param, false);
...
//START CRUD
  ...
  const validation = useFormik({
    ...
    initialValues: {
     brt_task_name:(budgetRequestTask && budgetRequestTask.brt_task_name) || "", 
brt_measurement:(budgetRequestTask && budgetRequestTask.brt_measurement) || "", 
brt_budget_request_id:(budgetRequestTask && budgetRequestTask.brt_budget_request_id) || "", 
brt_previous_year_physical:(budgetRequestTask && budgetRequestTask.brt_previous_year_physical) || "", 
brt_previous_year_financial:(budgetRequestTask && budgetRequestTask.brt_previous_year_financial) || "", 
brt_current_year_physical:(budgetRequestTask && budgetRequestTask.brt_current_year_physical) || "", 
brt_current_year_financial:(budgetRequestTask && budgetRequestTask.brt_current_year_financial) || "", 
brt_next_year_physical:(budgetRequestTask && budgetRequestTask.brt_next_year_physical) || "", 
brt_next_year_financial:(budgetRequestTask && budgetRequestTask.brt_next_year_financial) || "", 
brt_description:(budgetRequestTask && budgetRequestTask.brt_description) || "", 
...
brt_status:values.brt_status, 
        ...
        const newBudgetRequestTask = {
          brt_task_name:values.brt_task_name, 
brt_measurement:values.brt_measurement, 
brt_budget_request_id:budgetRequestId, 
brt_previous_year_physical:values.brt_previous_year_physical, 
brt_previous_year_financial:values.brt_previous_year_financial, 
brt_current_year_physical:values.brt_current_year_physical, 
brt_current_year_financial:values.brt_current_year_financial, 
      ...
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.brt_previous_year_physical, 30) ||
                '-'}
            </span>
          );
        },
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.brt_previous_year_financial, 30) ||
                '-'}
            </span>
          );
        },
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.brt_current_year_physical, 30) ||
                '-'}
            </span>
          );
        },
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.brt_current_year_financial, 30) ||
                '-'}
            </span>
          );
        },
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.brt_next_year_physical, 30) ||
                '-'}
            </span>
          );
        },
      }, 
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.brt_next_year_financial, 30) ||
                '-'}
            </span>
          );
        },
      ...
      />
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("budget_request_task")) : (t("add") +" "+t("budget_request_task"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
                ...
                <Row>
                  <Col>
                    <div className="text-end">
                      {addBudgetRequestTask.isPending || updateBudgetRequestTask.isPending ? (
                        <Button
                          color="success"
                          type="submit"
                          className="save-user"
