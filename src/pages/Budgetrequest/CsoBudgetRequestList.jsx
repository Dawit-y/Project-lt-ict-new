  ...
  const columnDefs = useMemo(() => {
    const baseColumnDefs = [
      ...
      },
      {
        ...
        width: 150,
        cellRenderer: (params) => {
          return truncateText(params.data.bdy_name, 60) || "-";
        },
      },
      {
        ...
        // flex: 2,
        cellRenderer: (params) => {
          return truncateText(params.data.prj_name, 60) || "-";
        },
      },
      {
        ...
        // flex: 1.5,
        cellRenderer: (params) => {
          return truncateText(params.data.prj_code, 60) || "-";
        },
      },
      {
        ...
        cellRenderer: (params) => {
          return truncateText(params.data.bdr_requested_date_gc, 60) || "-";
        },
      },
      {
