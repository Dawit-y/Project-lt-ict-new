...
const BudgetExipDetailModel = ({requestData}) => {
  //meta title
  document.title = " BudgetExipDetail";
  const budgetExpenId =requestData.pbe_id;
  const param = {budget_expend_id: requestData.pbe_id };
  ...
  const { data, isLoading, error, isError, refetch } = useFetchBudgetExipDetails(param);
...
//START CRUD
  ...
  const validation = useFormik({
    ...
    initialValues: {
     bed_budget_expenditure_id:(budgetExipDetail && budgetExipDetail.bed_budget_expenditure_id) || "", 
bed_budget_expenditure_code_id:(budgetExipDetail && budgetExipDetail.bed_budget_expenditure_code_id) || "", 
bed_amount:(budgetExipDetail && budgetExipDetail.bed_amount) || "", 
bed_description:(budgetExipDetail && budgetExipDetail.bed_description) || "", 
...
bed_budget_expenditure_code_id: numberValidation(1,500,true)
 .test("unique-role-id", t("Already exists"), (value) => {
          return !data?.data.some(
            (item) =>
              item.bed_budget_expenditure_code_id == value && item.bed_id !== budgetExipDetail?.bed_id
          );
        }),
...
bed_status:values.bed_status, 
        ...
        const newBudgetExipDetail = {
          bed_budget_expenditure_id:budgetExpenId, 
bed_budget_expenditure_code_id:values.bed_budget_expenditure_code_id, 
bed_amount:values.bed_amount, 
bed_description:values.bed_description, 
bed_status:values.bed_status, 
...
const toggle = () => {
   ...
   const handleBudgetExipDetailClick = (arg) => {
    ...
    // console.log("handleBudgetExipDetailClick", budgetExipDetail);
    setBudgetExipDetail({
      bed_id:budgetExipDetail.bed_id, 
bed_budget_expenditure_id:budgetExipDetail.bed_budget_expenditure_id, 
bed_budget_expenditure_code_id:budgetExipDetail.bed_budget_expenditure_code_id, 
    ...
    const baseColumns = [
{
        ...
        cell: (cellProps) => {
          return (
            <span>
              {truncateText(cellProps.row.original.bed_budget_expenditure_code_id, 30) ||
                '-'}
            </span>
          );
        },
        ...
        <div className="container-fluid1">
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("budget_exip_detail")) : (t("add") +" "+t("budget_exip_detail"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
              ...
              >
                <Row>
                    ...
                    <Input
                      ...
                      value={validation.values.bed_budget_expenditure_code_id || ""}
                      invalid={
                ...
                <Row>
                  <Col>
                    <div className="text-end">
                      {addBudgetExipDetail.isPending || updateBudgetExipDetail.isPending ? (
                        <Button
                          color="success"
                          type="submit"
                          className="save-user"
