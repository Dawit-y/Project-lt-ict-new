...
cso_description:(csoInfo && csoInfo.cso_description) || "", 
   ...
   validationSchema: Yup.object({
    cso_name: Yup.string().required(t('cso_name')),
cso_code: Yup.string().required(t('cso_code')),
cso_address: Yup.string().required(t('cso_address')),
cso_phone: Yup.string().required(t('cso_phone')),
cso_email: Yup.string().required(t('cso_email')),
cso_website: Yup.string().required(t('cso_website')),
cso_description: Yup.string().required(t('cso_description')),
   ...
   onSubmit: (values) => {
    if (isEdit) {
      const updateCsoInfo = {
        cso_id: csoInfo ? csoInfo.cso_id : 0,
...
cso_description:values.cso_description, 
  ...
  const handleCsoInfoClick = (arg) => {
    const csoInfo = arg;
    // console.log("handleCsoInfoClick", csoInfo);
    setCsoInfo({
      cso_id:csoInfo.cso_id, 
...
<Col className='col-md-6 mb-3'>
                      <Label>{t('cso_phone')}</Label>
                      <Input
                        name='cso_phone'
                        type='text'
                        placeholder={t('cso_phone')}
                        onChange={validation.handleChange}
                        onBlur={validation.handleBlur}
