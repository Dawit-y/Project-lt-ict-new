...
//bdm_code: Yup.string().required(t('bdm_code')),
//bdm_description: Yup.string().required(t('bdm_description')),
//bdm_status: Yup.string().required(t('bdm_status')),
