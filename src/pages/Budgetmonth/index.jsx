...
import { budgetMonthExportColumns } from "../../utils/exportColumnsForLookups";
...
const BudgetMonthModel = () => {
	...
	const columns = useMemo(() => {
		...
		return baseColumns;
	}, [handleBudgetMonthClick, toggleViewModal, onClickDelete, data, t]);

	if (isError) {
		return <FetchErrorHandler error={error} onRetry={refetch} />;
	}
