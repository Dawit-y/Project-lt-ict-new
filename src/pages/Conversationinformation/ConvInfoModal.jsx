      ...
      >
        <div className="modal-xl">
          <ModalHeader toggle={toggle}>
            {title ? title : t("view_messages")}
          </ModalHeader>
          <ModalBody>
            <Row className="d-felx align-items-center justify-content-center">
              <Col lg={10}>
                <Alert color="warning">
                    ...
                    <CardBody>
                      <CardTitle className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          <span className="fw-bold fs-5">{t("Notes Log")}</span>
                        </div>
                        <Button
                        ...
                        comments.map((comment) => (
                          ...
                          >
                            ...
                            <div className="flex-grow-1">
                              ...
                              <h6 className="my-2">
                                <strong>Subject: </strong> {comment?.cvi_title}
                              </h6>
