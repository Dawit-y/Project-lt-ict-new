...
const ProjectCategoryModel = () => {
  ...
  const { data, isLoading, error, isError, refetch } = useFetchProjectCategorys();
...
pct_description:(projectCategory && projectCategory.pct_description) || "", 
       ...
       pct_name_or: Yup.string()
        ...
        .test("unique-pct_name_or", t("Already exists"), (value) => {
          return !data?.data.some(
            (item) =>
              item.pct_name_or == value && item.pct_id !== projectCategory?.pct_id
          );
        }),
        ...
        <div className="container-fluid">
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("project_category")) : (t("add") +" "+t("project_category"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
                ...
                <Row>
                  <Col>
                    <div className="text-end">
                      {addProjectCategory.isPending || updateProjectCategory.isPending ? (
                        <Button
                          color="success"
                          type="submit"
                          className="save-user"
