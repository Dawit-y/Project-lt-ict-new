...
const SmsInformationModel = () => {
  ...
  const { data, isLoading, error, isError, refetch } = useFetchSmsInformations();
...
//START CRUD
  ...
  const validation = useFormik({
    ...
    initialValues: {
     smi_sms_template_id:(smsInformation && smsInformation.smi_sms_template_id) || "", 
    ...
    onSubmit: (values) => {
      if (isEdit) {
        const updateSmsInformation = {
          smi_id: smsInformation ? smsInformation.smi_id : 0,
            ...
            <div className="d-flex gap-3">
              {cellProps.row.original.is_editable==1 && (
                <Link
                  ...
                  onClick={() => {
                    const data = cellProps.row.original;                    
                    handleSmsInformationClick(data);
                  }}
                >
        ...
        <div className="container-fluid">
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("sms_information")) : (t("add") +" "+t("sms_information"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
                ...
                <Row>
                  <Col>
                    <div className="text-end">
                      {addSmsInformation.isPending || updateSmsInformation.isPending ? (
                        <Button
                          color="success"
                          type="submit"
                          className="save-user"
