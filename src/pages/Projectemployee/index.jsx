...
emp_start_date_ec:(projectEmployee && projectEmployee.emp_start_date_ec) || "", 
emp_start_date_gc:(projectEmployee && projectEmployee.emp_start_date_gc) || "", 
emp_end_date_ec:(projectEmployee && projectEmployee.emp_end_date_ec) || "", 
emp_end_date_gc:(projectEmployee && projectEmployee.emp_end_date_gc) || "", 
emp_address:(projectEmployee && projectEmployee.emp_address) || "", 
emp_description:(projectEmployee && projectEmployee.emp_description) || "", 
emp_current_status:(projectEmployee && projectEmployee.emp_current_status) || "", 
    ...
    onSubmit: (values) => {
      if (isEdit) {
        const updateProjectEmployee = {
          emp_id: projectEmployee ? projectEmployee.emp_id : 0,
        ...
        <div className="container-fluid">
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("project_employee")) : (t("add") +" "+t("project_employee"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
                ...
                <Row>
                  <Col>
                    <div className="text-end">
                      {addProjectEmployee.isPending || updateProjectEmployee.isPending ? (
                        <Button
                          color="success"
                          type="submit"
                          className="save-user"
