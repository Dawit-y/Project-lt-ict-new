...
const ProjectBudgetSourceModel = () => {
  ...
  const { data, isLoading, error, isError, refetch } = useFetchProjectBudgetSources();
...
bsr_project_id:(projectBudgetSource && projectBudgetSource.bsr_project_id) || "", 
bsr_budget_source_id:(projectBudgetSource && projectBudgetSource.bsr_budget_source_id) || "", 
...
bsr_description:(projectBudgetSource && projectBudgetSource.bsr_description) || "", 
bsr_created_date:(projectBudgetSource && projectBudgetSource.bsr_created_date) || "", 

is_deletable: (projectBudgetSource && projectBudgetSource.is_deletable) || 1,
is_editable: (projectBudgetSource && projectBudgetSource.is_editable) || 1
    },
    ...
    onSubmit: (values) => {
      if (isEdit) {
        const updateProjectBudgetSource = {
          bsr_id: projectBudgetSource ? projectBudgetSource.bsr_id : 0,
        ...
        <div className="container-fluid1">
          ...
          <Modal isOpen={modal} toggle={toggle} className="modal-xl">
            <ModalHeader toggle={toggle} tag="h4">
              {!!isEdit ? (t("edit") + " "+t("project_budget_source")) : (t("add") +" "+t("project_budget_source"))}
            </ModalHeader>
            <ModalBody>
              <Form
                onSubmit={(e) => {
                ...
                <Row>
                  <Col>
                    <div className="text-end">
                      {addProjectBudgetSource.isPending || updateProjectBudgetSource.isPending ? (
                        <Button
                          color="success"
                          type="submit"
                          className="save-user"
