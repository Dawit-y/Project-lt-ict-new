...
const ProjectPhysicalPerformanceTable = ({ data = [], exportSearchParams }) => {
	...
	const prepareExportData = (filteredData) => {
		...
		return filteredData.map((item) => ({
			...
			"Sep (Q1)": formatNumberForExport(item.prp_pyhsical_planned_month_11),
			"Oct (Q1)": formatNumberForExport(item.prp_pyhsical_planned_month_12),
			"Nov (Q1)": formatNumberForExport(item.prp_pyhsical_planned_month_1),
			"Q1 Total": formatNumberForExport(item.quarter1total),
			"Dec (Q2)": formatNumberForExport(item.prp_pyhsical_planned_month_2),
			"Jan (Q2)": formatNumberForExport(item.prp_pyhsical_planned_month_3),
			"Feb (Q2)": formatNumberForExport(item.prp_pyhsical_planned_month_4),
			"Q2 Total": formatNumberForExport(item.quarter2total),
			"Mar (Q3)": formatNumberForExport(item.prp_pyhsical_planned_month_5),
			"Apr (Q3)": formatNumberForExport(item.prp_pyhsical_planned_month_6),
			"May (Q3)": formatNumberForExport(item.prp_pyhsical_planned_month_7),
			"Q3 Total": formatNumberForExport(item.quarter3total),
			"Jun (Q4)": formatNumberForExport(item.prp_pyhsical_planned_month_8),
			"Jul (Q4)": formatNumberForExport(item.prp_pyhsical_planned_month_9),
			"Aug (Q4)": formatNumberForExport(item.prp_pyhsical_planned_month_10),
