...
const ProjectPhysicalPerformanceTable = ({
  ...
  const columnsConfig = useMemo(() => [
    ...
    { id: "prj_code", label: t("prj_code"), visible: true, minWidth: 100, sticky: true },
    { id: "prj_name", label: t("prj_name"), visible: true, minWidth: 150, sticky: true },
    { id: "prj_measurement_unit", label: t("prj_measurement_unit"), visible: true, minWidth: 80 },
    { id: "budgetyear", label: t("prp_budget_year_id"), visible: true, minWidth: 80 },
    { id: "prp_physical_baseline", label: t("prp_physical_baseline"), visible: true, minWidth: 80 },
    { id: "prp_physical_planned", label: t("prp_physical_planned"), visible: true, minWidth: 80 },
  ...
  return (
    <div style={{ width: "100%", overflowX: "auto" }}>
      <Card className="mb-3">
        <CardBody className="d-flex justify-content-between align-items-center">
          ...
          <div className="d-flex align-items-center">
            <ExportToExcel
              data={exportData}
              tableId="project-physical-performance-table"
              filename="ProjectPhysicalPerformanceTable"
      ...
      <div style={{ overflowX: "auto", width: "100%", borderRadius: "4px", marginBottom: "1rem" }}>
        ...
        <table
          id="project-physical-performance-table"
          ref={tableRef}
          ...
          <thead className={theadClass} style={{ position: "sticky", top: 0, zIndex: 3 }}>
            <tr ref={headerRowRef}>
              ...
              <th data-column="prp_physical_baseline" rowSpan="2">
                ...
                <div className="resize-handle" onMouseDown={(e) => startResizing("prp_physical_baseline", e)}></div>
              </th>
              ...
              <th data-column="q1_month1" colSpan="4">
                {t("Q1")}
                <div className="resize-handle" onMouseDown={(e) => startResizing("q1_month1", e)}></div>
              </th>
              <th data-column="q2_month1" colSpan="4">
                {t("Q2")}
                <div className="resize-handle" onMouseDown={(e) => startResizing("q2_month1", e)}></div>
              </th>
              <th data-column="q3_month1" colSpan="4">
                {t("Q3")}
                <div className="resize-handle" onMouseDown={(e) => startResizing("q3_month1", e)}></div>
              </th>
              <th data-column="q4_month1" colSpan="4">
                {t("Q4")}
                <div className="resize-handle" onMouseDown={(e) => startResizing("q4_month1", e)}></div>
              </th>
            </tr>
            <tr>
              ...
              currentRows.map((row, index) => {
                ...
                return (
                  <tr key={row.id || index} className={hasNoProjectName ? "no-project-name" : ""} style={{ textAlign: "center" }}>
                    ...
                    <td data-column="prp_physical_baseline">{row.prp_physical_baseline}</td>
                    <td data-column="prp_physical_planned">{row.prp_physical_planned}</td>
                    
                    <td data-column="q1_month1">{row.prp_pyhsical_planned_month_1 || " "}</td>
                    <td data-column="q1_month2">{row.prp_pyhsical_planned_month_2 || " "}</td>
                    <td data-column="q1_month3">{row.prp_pyhsical_planned_month_3 || " "}</td>
                    <td data-column="q1_sum"><strong>{row.quarter1total || " "}</strong></td>
                    
                    <td data-column="q2_month1">{row.prp_pyhsical_planned_month_4 || " "}</td>
                    <td data-column="q2_month2">{row.prp_pyhsical_planned_month_5 || " "}</td>
                    <td data-column="q2_month3">{row.prp_pyhsical_planned_month_6 || " "}</td>
                    <td data-column="q2_sum"><strong>{row.quarter2total || " "}</strong></td>
                    
                    <td data-column="q3_month1">{row.prp_pyhsical_planned_month_7 || " "}</td>
                    <td data-column="q3_month2">{row.prp_pyhsical_planned_month_8 || " "}</td>
                    <td data-column="q3_month3">{row.prp_pyhsical_planned_month_9 || " "}</td>
                    <td data-column="q3_sum"><strong>{row.quarter3total || " "}</strong></td>
                    
                    <td data-column="q4_month1">{row.prp_pyhsical_planned_month_10 || " "}</td>
                    <td data-column="q4_month2">{row.prp_pyhsical_planned_month_11 || " "}</td>
                    <td data-column="q4_month3">{row.prp_pyhsical_planned_month_12 || " "}</td>
                    <td data-column="q4_sum"><strong>{row.quarter4total || " "}</strong></td>
                  </tr>
                );
              })
            ) : (
