...
import { projectPhysicalPerformanceExportColumns } from "../../utils/exportColumnsForReport";
import ExportToExcel from "./Export/ExportPhysicalPerformance";
      ...
      <Card className="mb-3">
        <CardBody className="d-flex justify-content-between align-items-center">
          ...
          <div className="d-flex align-items-center justify-content-center gap-2">
            <ExportToExcel
              tableData={data}
              tableName="ProjectPhysicalPerformanceReport"
              exportColumns={projectPhysicalPerformanceExportColumns}
            />
            ...
            >
              <DropdownToggle
                tag={Button}
                color="secondary"
                className="btn btn-soft-primary py-2"
                style={{
        ...
        >
          ...
          >
            ...
            <th data-column="q1_month1">{t("Jul")}</th>
              ...
              <th data-column="q4_month1">{t("Apr")}</th>
              <th data-column="q4_month2">{t("May")}</th>              
                ...
                return (
                  ...
                  >
                    ...
                    <td data-column="q1_month1">
                      {row.prp_pyhsical_planned_month_11 || " "}
                    </td>
                    <td data-column="q1_month2">
                      {row.prp_pyhsical_planned_month_12 || " "}
                    </td>
                    <td data-column="q1_month3">
                      {row.prp_pyhsical_planned_month_1 || " "}
                    </td>
                    ...
                    <td data-column="q2_month1">
                      {row.prp_pyhsical_planned_month_2 || " "}
                    </td>
                    <td data-column="q2_month2">
                      {row.prp_pyhsical_planned_month_3 || " "}
                    </td>
                    <td data-column="q2_month3">
                      {row.prp_pyhsical_planned_month_4 || " "}
                    </td>
                    ...
                    <td data-column="q3_month1">
                      {row.prp_pyhsical_planned_month_5 || " "}
                    </td>
                    <td data-column="q3_month2">
                      {row.prp_pyhsical_planned_month_6 || " "}
                    </td>
                    <td data-column="q3_month3">
                      {row.prp_pyhsical_planned_month_7 || " "}
                    </td>
                    ...
                    <td data-column="q4_month1">
                      {row.prp_pyhsical_planned_month_8 || " "}
                    </td>
                    <td data-column="q4_month2">
                      {row.prp_pyhsical_planned_month_9 || " "}
                    </td>
                    <td data-column="q4_month3">
                      {row.prp_pyhsical_planned_month_10 || " "}
                    </td>
