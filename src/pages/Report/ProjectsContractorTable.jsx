...
const ProjectContractorTable = ({
  ...
  const groupedData = React.useMemo(() => {
    ...
    data.forEach((item) => {
      ...
      const contractPrice =
        Number(String(item["Contract Price"]).replace(/[^0-9.-]+/g, "")) || 0;
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <div className="d-flex flex-column">
            {row.original.contractors.map((contractor, i) => (
              <div key={i}>
                {contractor.endDate === "N/A"
                  ? "N/A"
                  : new Date(contractor.endDate).toLocaleDateString()}
              </div>
            ))}
          </div>
        ),
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <div className="d-flex flex-column">
            {row.original.contractors.map((contractor, i) => (
              <div key={i}>
                {contractor.invitationDate === "N/A"
                  ? "N/A"
                  : new Date(contractor.invitationDate).toLocaleDateString()}
              </div>
            ))}
          </div>
        ),
      },
      {
        ...
        Cell: ({ row }) => (
          <div className="d-flex flex-column">
            {row.original.contractors.map((contractor, i) => (
              <div key={i}>
                {contractor.signingDate === "N/A"
                  ? "N/A"
                  : new Date(contractor.signingDate).toLocaleDateString()}
              </div>
            ))}
          </div>
        ),
