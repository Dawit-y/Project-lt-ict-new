              ...
              currentRows.map((row, index) => {
                ...
                return (
                  <tr key={row.id || index} className={hasNoProjectName ? "no-project-name" : ""} style={{ textAlign: "center" }}>
                    ...
                    <td data-column="q1_month1">{row.prp_finan_planned_month_1 || " "}</td>
                    <td data-column="q1_month2">{row.prp_finan_planned_month_2 || " "}</td>
                    <td data-column="q1_month3">{row.prp_finan_planned_month_3 || " "}</td>
                    <td data-column="q1_sum"><strong>{row.quarter1total || " "}</strong></td>
                    
                    <td data-column="q2_month1">{row.prp_finan_planned_month_4 || " "}</td>
                    <td data-column="q2_month2">{row.prp_finan_planned_month_5 || " "}</td>
                    <td data-column="q2_month3">{row.prp_finan_planned_month_6 || " "}</td>
                    <td data-column="q2_sum"><strong>{row.quarter2total || " "}</strong></td>
                    
                    <td data-column="q3_month1">{row.prp_finan_planned_month_7 || " "}</td>
                    <td data-column="q3_month2">{row.prp_finan_planned_month_8 || " "}</td>
                    <td data-column="q3_month3">{row.prp_finan_planned_month_9 || " "}</td>
                    <td data-column="q3_sum"><strong>{row.quarter3total || " "}</strong></td>
                    
                    <td data-column="q4_month1">{row.prp_finan_planned_month_10 || " "}</td>
                    <td data-column="q4_month2">{row.prp_finan_planned_month_11 || " "}</td>
                    <td data-column="q4_month3">{row.prp_finan_planned_month_12 || " "}</td>
