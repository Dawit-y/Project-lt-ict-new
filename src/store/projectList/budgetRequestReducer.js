...
const budgetRequestListReducer = (state = initialState, action) => {
	if (action.meta?.namespace !== "budgetRequestList") {
		return state;
	}
...
export default budgetRequestListReducer;
