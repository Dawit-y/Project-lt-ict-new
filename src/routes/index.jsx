...
const CSOActivityList = lazy(() =>
	import("../pages/Csoproject/ActivityList.jsx")
);
...
const ProjectMonitoringEvaluation = lazy(() =>
	import("../pages/Projectmonitoringevaluation/index")
);
const MonitoringEvaluationTypeList = lazy(() =>
	import("../pages/Monitoringevaluationtype/MonitoringEvaluationTypeList")
);
const ProjectMonitoringEvaluationList = lazy(() =>
	import("../pages/Projectmonitoringevaluation/ProjectMonitoringEvaluationList")
);
...
const authProtectedRoutes = [
	...
	{
		path: "/monitoring_evaluation_list",
		component: <ProjectMonitoringEvaluationList />,
	},
	{
		path: "/monitoring_evaluation_type",
		component: <MonitoringEvaluationType />,
	},
	{
		path: "/project_monitoring_evaluation",
		component: <ProjectMonitoringEvaluation />,
	},
