...
const ADD_CONTRACT_TERMINATION_REASON =
  "contract_termination_reason/insertgrid";
const UPDATE_CONTRACT_TERMINATION_REASON =
  "contract_termination_reason/updategrid";
const DELETE_CONTRACT_TERMINATION_REASON =
  "contract_termination_reason/deletegrid";
// get contract_termination_reason
export const getContractTerminationReason = async (params = {}) => {
  const queryString = new URLSearchParams(params).toString();
  const url = queryString
    ? `${GET_CONTRACT_TERMINATION_REASON}?${queryString}`
